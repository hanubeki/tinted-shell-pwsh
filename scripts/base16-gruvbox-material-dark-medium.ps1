# tinted-shell (base16) Gruvbox Material Dark, Medium for PowerShell
# scheme made by Mayush Kumar (https://github.com/MayushKumar), sainnhe (https://github.com/sainnhe/gruvbox-material-vscode)

$Env:BASE16_THEME = "gruvbox-material-dark-medium"

Write-Host -NoNewline "`e]4;0;rgb:29/28/28`e\" # base00
...
if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:29/28/28`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:dd/c7/a1`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "292828"
