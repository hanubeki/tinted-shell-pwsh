# tinted-shell (base16) Solarized Light for PowerShell
# scheme made by Ethan Schoonover (modified by aramisgithub)

$Env:BASE16_THEME = "solarized-light"
...
Write-Host -NoNewline "`e]4;7;rgb:58/6e/75`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:83/94/96`e\" # base03
...
Write-Host -NoNewline "`e]4;18;rgb:ee/e8/d5`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:93/a1/a1`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:65/7b/83`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:07/36/42`e\" # base06

Write-Host -NoNewline "`e]10;rgb:58/6e/75`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:fd/f6/e3`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:58/6e/75`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "fdf6e3"
    $Env:BASE16_COLOR_01_HEX = "eee8d5"
    $Env:BASE16_COLOR_02_HEX = "93a1a1"
    $Env:BASE16_COLOR_03_HEX = "839496"
    $Env:BASE16_COLOR_04_HEX = "657b83"
    $Env:BASE16_COLOR_05_HEX = "586e75"
    $Env:BASE16_COLOR_06_HEX = "073642"
    $Env:BASE16_COLOR_07_HEX = "002b36"
