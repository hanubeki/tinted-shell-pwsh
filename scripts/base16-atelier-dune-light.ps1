# tinted-shell (base16) Atelier Dune Light for PowerShell
# scheme made by Bram de Haan (http://atelierbramdehaan.nl)

$Env:BASE16_THEME = "atelier-dune-light"

Write-Host -NoNewline "`e]4;0;rgb:fe/fb/ec`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:6e/6b/5e`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:99/95/80`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:20/20/1d`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:b6/56/11`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:d4/35/52`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:e8/e4/cf`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:a6/a2/8c`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:7d/7a/68`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:29/28/24`e\" # base06

Write-Host -NoNewline "`e]10;rgb:6e/6b/5e`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:fe/fb/ec`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:6e/6b/5e`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "fefbec"
    $Env:BASE16_COLOR_01_HEX = "e8e4cf"
    $Env:BASE16_COLOR_02_HEX = "a6a28c"
    $Env:BASE16_COLOR_03_HEX = "999580"
    $Env:BASE16_COLOR_04_HEX = "7d7a68"
    $Env:BASE16_COLOR_05_HEX = "6e6b5e"
    $Env:BASE16_COLOR_06_HEX = "292824"
    $Env:BASE16_COLOR_07_HEX = "20201d"
