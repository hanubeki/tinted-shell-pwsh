# tinted-shell (base24) Github Light Colorblind for PowerShell
# scheme made by Tinted Theming (https://github.com/tinted-theming)

$Env:BASE24_THEME = "github-light-colorblind"

Write-Host -NoNewline "`e]4;0;rgb:ff/ff/ff`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:8a/46/00`e\" # base08
...
Write-Host -NoNewline "`e]4;5;rgb:b3/59/00`e\" # base0E
Write-Host -NoNewline "`e]4;6;rgb:05/50/ae`e\" # base0C
Write-Host -NoNewline "`e]4;7;rgb:42/4a/53`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:8c/95/9f`e\" # base03
Write-Host -NoNewline "`e]4;9;rgb:f7/99/39`e\" # base12
Write-Host -NoNewline "`e]4;10;rgb:54/ae/ff`e\" # base14
...
Write-Host -NoNewline "`e]4;15;rgb:24/29/2f`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:05/50/ae`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:6f/38/00`e\" # base0F
...
# Write-Host -NoNewline "`e]4;22;rgb:24/29/2f`e\" # base10
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    ...
    $Env:BASE24_COLOR_07_HEX = "24292f"
    $Env:BASE24_COLOR_08_HEX = "8a4600"
    $Env:BASE24_COLOR_09_HEX = "0550ae"
    $Env:BASE24_COLOR_0A_HEX = "bf8700"
    $Env:BASE24_COLOR_0B_HEX = "0a3069"
    $Env:BASE24_COLOR_0C_HEX = "0550ae"
    $Env:BASE24_COLOR_0D_HEX = "8250df"
    $Env:BASE24_COLOR_0E_HEX = "b35900"
    $Env:BASE24_COLOR_0F_HEX = "6f3800"
    $Env:BASE24_COLOR_10_HEX = "24292f"
    $Env:BASE24_COLOR_11_HEX = "000000"
    $Env:BASE24_COLOR_12_HEX = "f79939"
    $Env:BASE24_COLOR_13_HEX = "d4a72c"
    $Env:BASE24_COLOR_14_HEX = "54aeff"
