# tinted-shell (base16) Brush Trees Dark for PowerShell
# scheme made by Abraham White &lt;abelincoln.white@gmail.com&gt;

$Env:BASE16_THEME = "brushtrees-dark"

Write-Host -NoNewline "`e]4;0;rgb:48/58/67`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:b0/c5/c8`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:82/99/a1`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:e3/ef/ef`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:d8/bb/a2`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:b3/9f/9f`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:5a/6d/7a`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:6d/82/8e`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:98/af/b5`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:c9/db/dc`e\" # base06

Write-Host -NoNewline "`e]10;rgb:b0/c5/c8`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:48/58/67`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:b0/c5/c8`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "485867"
    $Env:BASE16_COLOR_01_HEX = "5a6d7a"
    $Env:BASE16_COLOR_02_HEX = "6d828e"
    $Env:BASE16_COLOR_03_HEX = "8299a1"
    $Env:BASE16_COLOR_04_HEX = "98afb5"
    $Env:BASE16_COLOR_05_HEX = "b0c5c8"
    $Env:BASE16_COLOR_06_HEX = "c9dbdc"
    $Env:BASE16_COLOR_07_HEX = "e3efef"
