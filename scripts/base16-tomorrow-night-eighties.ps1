# tinted-shell (base16) Tomorrow Night Eighties for PowerShell
# scheme made by Chris Kempson (http://chriskempson.com)

$Env:BASE16_THEME = "tomorrow-night-eighties"
...
Write-Host -NoNewline "`e]4;8;rgb:99/99/99`e\" # base03
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_03_HEX = "999999"
