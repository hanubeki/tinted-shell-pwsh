# tinted-shell (base24) Night Lion V1 for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "night-lion-v1"

Write-Host -NoNewline "`e]4;0;rgb:00/00/00`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:bb/00/00`e\" # base08
Write-Host -NoNewline "`e]4;2;rgb:5e/de/8f`e\" # base0B
Write-Host -NoNewline "`e]4;3;rgb:55/55/ff`e\" # base0A
Write-Host -NoNewline "`e]4;4;rgb:26/6a/d7`e\" # base0D
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    ...
    $Env:BASE24_COLOR_0B_HEX = "5ede8f"
    $Env:BASE24_COLOR_0C_HEX = "00d9df"
    $Env:BASE24_COLOR_0D_HEX = "266ad7"
