# tinted-shell (base24) Shaman for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "shaman"

Write-Host -NoNewline "`e]4;0;rgb:00/10/14`e\" # base00
...
Write-Host -NoNewline "`e]4;16;rgb:5d/8a/a9`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:58/17/16`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:01/20/26`e\" # base01
...
if ($Env:BASE24_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:00/10/14`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:3d/50/53`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "001014"
    $Env:BASE24_COLOR_01_HEX = "012026"
    ...
    $Env:BASE24_COLOR_09_HEX = "5d8aa9"
