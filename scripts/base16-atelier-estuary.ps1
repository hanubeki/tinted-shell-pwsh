# tinted-shell (base16) Atelier Estuary for PowerShell
# scheme made by Bram de Haan (http://atelierbramdehaan.nl)

$Env:BASE16_THEME = "atelier-estuary"

Write-Host -NoNewline "`e]4;0;rgb:22/22/1b`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:92/91/81`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:6c/6b/5a`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:f4/f3/ec`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:ae/73/13`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:9d/6c/7c`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:30/2f/27`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:5f/5e/4e`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:87/85/73`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:e7/e6/df`e\" # base06

Write-Host -NoNewline "`e]10;rgb:92/91/81`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:22/22/1b`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:92/91/81`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "22221b"
    $Env:BASE16_COLOR_01_HEX = "302f27"
    $Env:BASE16_COLOR_02_HEX = "5f5e4e"
    $Env:BASE16_COLOR_03_HEX = "6c6b5a"
    $Env:BASE16_COLOR_04_HEX = "878573"
    $Env:BASE16_COLOR_05_HEX = "929181"
    $Env:BASE16_COLOR_06_HEX = "e7e6df"
    $Env:BASE16_COLOR_07_HEX = "f4f3ec"
