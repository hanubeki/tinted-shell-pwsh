# tinted-shell (base16) Da One Ocean for PowerShell
# scheme made by NNB (https://github.com/NNBnh)

$Env:BASE16_THEME = "da-one-ocean"

Write-Host -NoNewline "`e]4;0;rgb:17/17/26`e\" # base00
...
Write-Host -NoNewline "`e]4;18;rgb:22/27/3d`e\" # base01
...
if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:17/17/26`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:ff/ff/ff`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "171726"
    $Env:BASE16_COLOR_01_HEX = "22273d"
