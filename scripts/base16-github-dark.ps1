# tinted-shell (base16) Github Dark for PowerShell
# scheme made by Tinted Theming (https://github.com/tinted-theming)

$Env:BASE16_THEME = "github-dark"
...
Write-Host -NoNewline "`e]4;9;rgb:ff/a6/57`e\" # base08
...
Write-Host -NoNewline "`e]4;13;rgb:ff/7b/72`e\" # base0E
Write-Host -NoNewline "`e]4;14;rgb:7e/e7/87`e\" # base0C
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_08_HEX = "ffa657"
    $Env:BASE16_COLOR_09_HEX = "79c0ff"
    $Env:BASE16_COLOR_0A_HEX = "bb8009"
    $Env:BASE16_COLOR_0B_HEX = "a5d6ff"
    $Env:BASE16_COLOR_0C_HEX = "7ee787"
    $Env:BASE16_COLOR_0D_HEX = "d2a8ff"
    $Env:BASE16_COLOR_0E_HEX = "ff7b72"
    $Env:BASE16_COLOR_0F_HEX = "ffa198"
}
