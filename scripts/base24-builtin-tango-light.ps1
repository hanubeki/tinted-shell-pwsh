# tinted-shell (base24) Builtin Tango Light for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "builtin-tango-light"

Write-Host -NoNewline "`e]4;0;rgb:ff/ff/ff`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:cc/00/00`e\" # base08
Write-Host -NoNewline "`e]4;2;rgb:4e/9a/05`e\" # base0B
Write-Host -NoNewline "`e]4;3;rgb:71/9e/cf`e\" # base0A
Write-Host -NoNewline "`e]4;4;rgb:34/64/a4`e\" # base0D
Write-Host -NoNewline "`e]4;5;rgb:74/50/7a`e\" # base0E
...
Write-Host -NoNewline "`e]4;11;rgb:fc/e9/4e`e\" # base13
Write-Host -NoNewline "`e]4;12;rgb:71/9e/cf`e\" # base16
Write-Host -NoNewline "`e]4;13;rgb:ad/7e/a7`e\" # base17
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    ...
    $Env:BASE24_COLOR_0A_HEX = "719ecf"
    $Env:BASE24_COLOR_0B_HEX = "4e9a05"
    $Env:BASE24_COLOR_0C_HEX = "05989a"
    $Env:BASE24_COLOR_0D_HEX = "3464a4"
    $Env:BASE24_COLOR_0E_HEX = "74507a"
    $Env:BASE24_COLOR_0F_HEX = "660000"
    $Env:BASE24_COLOR_10_HEX = "383a37"
    $Env:BASE24_COLOR_11_HEX = "1c1d1b"
    $Env:BASE24_COLOR_12_HEX = "ef2828"
    $Env:BASE24_COLOR_13_HEX = "fce94e"
    $Env:BASE24_COLOR_14_HEX = "8ae234"
    $Env:BASE24_COLOR_15_HEX = "34e2e2"
    $Env:BASE24_COLOR_16_HEX = "719ecf"
    $Env:BASE24_COLOR_17_HEX = "ad7ea7"
}
