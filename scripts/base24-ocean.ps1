# tinted-shell (base24) Ocean for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "ocean"

Write-Host -NoNewline "`e]4;0;rgb:22/4f/bc`e\" # base00
...
if ($Env:BASE24_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:22/4f/bc`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:a8/a8/a8`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "224fbc"
