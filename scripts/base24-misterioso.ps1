# tinted-shell (base24) Misterioso for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "misterioso"

Write-Host -NoNewline "`e]4;0;rgb:2d/37/43`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:be/be/bd`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:78/78/77`e\" # base03
...
Write-Host -NoNewline "`e]4;20;rgb:9b/9b/9a`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:e1/e1/e0`e\" # base06
# Write-Host -NoNewline "`e]4;22;rgb:38/38/38`e\" # base10
# Write-Host -NoNewline "`e]4;23;rgb:1c/1c/1c`e\" # base11

Write-Host -NoNewline "`e]10;rgb:be/be/bd`e\" # base05

if ($Env:BASE24_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:2d/37/43`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:be/be/bd`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "2d3743"
    $Env:BASE24_COLOR_01_HEX = "000000"
    $Env:BASE24_COLOR_02_HEX = "555555"
    $Env:BASE24_COLOR_03_HEX = "787877"
    $Env:BASE24_COLOR_04_HEX = "9b9b9a"
    $Env:BASE24_COLOR_05_HEX = "bebebd"
    $Env:BASE24_COLOR_06_HEX = "e1e1e0"
