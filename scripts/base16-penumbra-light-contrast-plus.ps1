# tinted-shell (base16) Penumbra Light Contrast Plus for PowerShell
# scheme made by Zachary Weiss (https://github.com/zacharyweiss)

$Env:BASE16_THEME = "penumbra-light-contrast-plus"
...
Write-Host -NoNewline "`e]4;8;rgb:ce/ce/ce`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:18/1b/1f`e\" # base07
...
Write-Host -NoNewline "`e]4;21;rgb:24/27/2b`e\" # base06
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_03_HEX = "cecece"
    $Env:BASE16_COLOR_04_HEX = "9e9e9e"
    $Env:BASE16_COLOR_05_HEX = "636363"
    $Env:BASE16_COLOR_06_HEX = "24272b"
    $Env:BASE16_COLOR_07_HEX = "181b1f"
