# tinted-shell (base24) Violet Light for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "violet-light"

Write-Host -NoNewline "`e]4;0;rgb:fc/f4/dc`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:af/ae/a9`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:68/6a/6a`e\" # base03
...
Write-Host -NoNewline "`e]4;20;rgb:8c/8c/8a`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:d3/d0/c9`e\" # base06
# Write-Host -NoNewline "`e]4;22;rgb:2e/30/32`e\" # base10
# Write-Host -NoNewline "`e]4;23;rgb:17/18/19`e\" # base11

Write-Host -NoNewline "`e]10;rgb:af/ae/a9`e\" # base05

if ($Env:BASE24_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:fc/f4/dc`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:af/ae/a9`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "fcf4dc"
    $Env:BASE24_COLOR_01_HEX = "56595c"
    $Env:BASE24_COLOR_02_HEX = "45484b"
    $Env:BASE24_COLOR_03_HEX = "686a6a"
    $Env:BASE24_COLOR_04_HEX = "8c8c8a"
    $Env:BASE24_COLOR_05_HEX = "afaea9"
    $Env:BASE24_COLOR_06_HEX = "d3d0c9"
