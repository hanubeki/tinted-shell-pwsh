# tinted-shell (base16) Atelier Sulphurpool Light for PowerShell
# scheme made by Bram de Haan (http://atelierbramdehaan.nl)

$Env:BASE16_THEME = "atelier-sulphurpool-light"

Write-Host -NoNewline "`e]4;0;rgb:f5/f7/ff`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:5e/66/87`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:89/8e/a4`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:20/27/46`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:c7/6b/29`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:9c/63/7a`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:df/e2/f1`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:97/9d/b4`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:6b/73/94`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:29/32/56`e\" # base06

Write-Host -NoNewline "`e]10;rgb:5e/66/87`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:f5/f7/ff`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:5e/66/87`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "f5f7ff"
    $Env:BASE16_COLOR_01_HEX = "dfe2f1"
    $Env:BASE16_COLOR_02_HEX = "979db4"
    $Env:BASE16_COLOR_03_HEX = "898ea4"
    $Env:BASE16_COLOR_04_HEX = "6b7394"
    $Env:BASE16_COLOR_05_HEX = "5e6687"
    $Env:BASE16_COLOR_06_HEX = "293256"
    $Env:BASE16_COLOR_07_HEX = "202746"
