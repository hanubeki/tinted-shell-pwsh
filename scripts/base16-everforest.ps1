# tinted-shell (base16) Everforest for PowerShell
# scheme made by Sainnhe Park (https://github.com/sainnhe)

$Env:BASE16_THEME = "everforest"
...
Write-Host -NoNewline "`e]4;19;rgb:47/52/58`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:9d/a9/a0`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:e6/e2/cc`e\" # base06
