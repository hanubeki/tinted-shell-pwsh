# tinted-shell (base24) Atelier Sulphurpool for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "atelier-sulphurpool"
...
Write-Host -NoNewline "`e]4;10;rgb:29/32/56`e\" # base14
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "202746"
    ...
    $Env:BASE24_COLOR_14_HEX = "293256"
