# tinted-shell (base16) Everforest Dark Hard for PowerShell
# scheme made by Sainnhe Park (https://github.com/sainnhe)

$Env:BASE16_THEME = "everforest-dark-hard"

Write-Host -NoNewline "`e]4;0;rgb:27/2e/33`e\" # base00
...
Write-Host -NoNewline "`e]4;15;rgb:ff/fb/ef`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:e6/98/75`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:9d/a9/a0`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:2e/38/3c`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:41/4b/50`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:9d/a9/a0`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:ed/ea/da`e\" # base06

Write-Host -NoNewline "`e]10;rgb:d3/c6/aa`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:27/2e/33`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:d3/c6/aa`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "272e33"
    $Env:BASE16_COLOR_01_HEX = "2e383c"
    $Env:BASE16_COLOR_02_HEX = "414b50"
    $Env:BASE16_COLOR_03_HEX = "859289"
    $Env:BASE16_COLOR_04_HEX = "9da9a0"
    $Env:BASE16_COLOR_05_HEX = "d3c6aa"
    $Env:BASE16_COLOR_06_HEX = "edeada"
    $Env:BASE16_COLOR_07_HEX = "fffbef"
