# tinted-shell (base16) Atelier Lakeside for PowerShell
# scheme made by Bram de Haan (http://atelierbramdehaan.nl)

$Env:BASE16_THEME = "atelier-lakeside"

Write-Host -NoNewline "`e]4;0;rgb:16/1b/1d`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:7e/a2/b4`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:5a/7b/8c`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:eb/f8/ff`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:93/5c/25`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:b7/2d/d2`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:1f/29/2e`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:51/6d/7b`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:71/95/a8`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:c1/e4/f6`e\" # base06

Write-Host -NoNewline "`e]10;rgb:7e/a2/b4`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:16/1b/1d`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:7e/a2/b4`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "161b1d"
    $Env:BASE16_COLOR_01_HEX = "1f292e"
    $Env:BASE16_COLOR_02_HEX = "516d7b"
    $Env:BASE16_COLOR_03_HEX = "5a7b8c"
    $Env:BASE16_COLOR_04_HEX = "7195a8"
    $Env:BASE16_COLOR_05_HEX = "7ea2b4"
    $Env:BASE16_COLOR_06_HEX = "c1e4f6"
    $Env:BASE16_COLOR_07_HEX = "ebf8ff"
