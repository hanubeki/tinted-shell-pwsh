# tinted-shell (base24) One Dark for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "one-dark"
...
Write-Host -NoNewline "`e]4;18;rgb:3f/44/51`e\" # base01
...
# Write-Host -NoNewline "`e]4;22;rgb:21/25/2b`e\" # base10
# Write-Host -NoNewline "`e]4;23;rgb:18/1a/1f`e\" # base11
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "282c34"
    $Env:BASE24_COLOR_01_HEX = "3f4451"
    ...
    $Env:BASE24_COLOR_10_HEX = "21252b"
    $Env:BASE24_COLOR_11_HEX = "181a1f"
