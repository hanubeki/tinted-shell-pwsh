# tinted-shell (base16) Embers for PowerShell
# scheme made by Jannik Siebert (https://github.com/janniks)

$Env:BASE16_THEME = "embers"

Write-Host -NoNewline "`e]4;0;rgb:16/13/0f`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:a3/9a/90`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:5a/50/47`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:db/d6/d1`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:82/82/57`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:82/57/57`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:2c/26/20`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:43/3b/32`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:8a/80/75`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:be/b6/ae`e\" # base06

Write-Host -NoNewline "`e]10;rgb:a3/9a/90`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:16/13/0f`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:a3/9a/90`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "16130f"
    $Env:BASE16_COLOR_01_HEX = "2c2620"
    $Env:BASE16_COLOR_02_HEX = "433b32"
    $Env:BASE16_COLOR_03_HEX = "5a5047"
    $Env:BASE16_COLOR_04_HEX = "8a8075"
    $Env:BASE16_COLOR_05_HEX = "a39a90"
    $Env:BASE16_COLOR_06_HEX = "beb6ae"
    $Env:BASE16_COLOR_07_HEX = "dbd6d1"
