# tinted-shell (base16) Harmonic16 Light for PowerShell
# scheme made by Jannik Siebert (https://github.com/janniks)

$Env:BASE16_THEME = "harmonic16-light"

Write-Host -NoNewline "`e]4;0;rgb:f7/f9/fb`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:40/5c/79`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:aa/bc/ce`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:0b/1c/2c`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:bf/bf/56`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:bf/56/56`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:e5/eb/f1`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:cb/d6/e2`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:62/7e/99`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:22/3b/54`e\" # base06

Write-Host -NoNewline "`e]10;rgb:40/5c/79`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:f7/f9/fb`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:40/5c/79`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "f7f9fb"
    $Env:BASE16_COLOR_01_HEX = "e5ebf1"
    $Env:BASE16_COLOR_02_HEX = "cbd6e2"
    $Env:BASE16_COLOR_03_HEX = "aabcce"
    $Env:BASE16_COLOR_04_HEX = "627e99"
    $Env:BASE16_COLOR_05_HEX = "405c79"
    $Env:BASE16_COLOR_06_HEX = "223b54"
    $Env:BASE16_COLOR_07_HEX = "0b1c2c"
