# tinted-shell (base24) Github Dark Colorblind for PowerShell
# scheme made by Tinted Theming (https://github.com/tinted-theming)

$Env:BASE24_THEME = "github-dark-colorblind"
...
Write-Host -NoNewline "`e]4;9;rgb:ec/8e/2c`e\" # base12
Write-Host -NoNewline "`e]4;10;rgb:58/a6/ff`e\" # base14
