# tinted-shell (base24) Night Lion V2 for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "night-lion-v2"

Write-Host -NoNewline "`e]4;0;rgb:17/17/17`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:bb/00/00`e\" # base08
Write-Host -NoNewline "`e]4;2;rgb:03/f6/22`e\" # base0B
Write-Host -NoNewline "`e]4;3;rgb:62/ca/e7`e\" # base0A
Write-Host -NoNewline "`e]4;4;rgb:63/d0/f0`e\" # base0D
Write-Host -NoNewline "`e]4;5;rgb:ce/6f/da`e\" # base0E
Write-Host -NoNewline "`e]4;6;rgb:00/d9/df`e\" # base0C
...
Write-Host -NoNewline "`e]4;10;rgb:7d/f6/1c`e\" # base14
Write-Host -NoNewline "`e]4;11;rgb:ff/ff/55`e\" # base13
Write-Host -NoNewline "`e]4;12;rgb:62/ca/e7`e\" # base16
Write-Host -NoNewline "`e]4;13;rgb:ff/9a/f5`e\" # base17
Write-Host -NoNewline "`e]4;14;rgb:00/cc/d7`e\" # base15
Write-Host -NoNewline "`e]4;15;rgb:ff/ff/ff`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:f2/f0/67`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:5d/00/00`e\" # base0F
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    ...
    $Env:BASE24_COLOR_08_HEX = "bb0000"
    $Env:BASE24_COLOR_09_HEX = "f2f067"
    $Env:BASE24_COLOR_0A_HEX = "62cae7"
    $Env:BASE24_COLOR_0B_HEX = "03f622"
    $Env:BASE24_COLOR_0C_HEX = "00d9df"
    $Env:BASE24_COLOR_0D_HEX = "63d0f0"
    $Env:BASE24_COLOR_0E_HEX = "ce6fda"
    $Env:BASE24_COLOR_0F_HEX = "5d0000"
    $Env:BASE24_COLOR_10_HEX = "383838"
    $Env:BASE24_COLOR_11_HEX = "1c1c1c"
    $Env:BASE24_COLOR_12_HEX = "ff5555"
    $Env:BASE24_COLOR_13_HEX = "ffff55"
    $Env:BASE24_COLOR_14_HEX = "7df61c"
    $Env:BASE24_COLOR_15_HEX = "00ccd7"
    $Env:BASE24_COLOR_16_HEX = "62cae7"
    $Env:BASE24_COLOR_17_HEX = "ff9af5"
}
