# tinted-shell (base24) Man Page for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "man-page"

Write-Host -NoNewline "`e]4;0;rgb:fe/f4/9c`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:b2/b2/b2`e\" # base05
...
Write-Host -NoNewline "`e]10;rgb:b2/b2/b2`e\" # base05

if ($Env:BASE24_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:fe/f4/9c`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:b2/b2/b2`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "fef49c"
    $Env:BASE24_COLOR_01_HEX = "000000"
    $Env:BASE24_COLOR_02_HEX = "666666"
    $Env:BASE24_COLOR_03_HEX = "7f7f7f"
    $Env:BASE24_COLOR_04_HEX = "999999"
    $Env:BASE24_COLOR_05_HEX = "b2b2b2"
