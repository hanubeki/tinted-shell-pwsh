# tinted-shell (base24) Builtin Light for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "builtin-light"
...
Write-Host -NoNewline "`e]4;4;rgb:00/00/bb`e\" # base0D
...
Write-Host -NoNewline "`e]4;16;rgb:bb/bb/00`e\" # base09
