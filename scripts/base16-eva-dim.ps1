# tinted-shell (base16) Eva Dim for PowerShell
# scheme made by kjakapat (https://github.com/kjakapat)

$Env:BASE16_THEME = "eva-dim"

Write-Host -NoNewline "`e]4;0;rgb:2a/3b/4d`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:c4/67/6c`e\" # base08
Write-Host -NoNewline "`e]4;2;rgb:5d/e5/61`e\" # base0B
Write-Host -NoNewline "`e]4;3;rgb:cf/d0/5d`e\" # base0A
Write-Host -NoNewline "`e]4;4;rgb:1a/e1/dc`e\" # base0D
...
Write-Host -NoNewline "`e]4;10;rgb:5d/e5/61`e\" # base0B
Write-Host -NoNewline "`e]4;11;rgb:cf/d0/5d`e\" # base0A
Write-Host -NoNewline "`e]4;12;rgb:1a/e1/dc`e\" # base0D
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_0A_HEX = "cfd05d"
    $Env:BASE16_COLOR_0B_HEX = "5de561"
    $Env:BASE16_COLOR_0C_HEX = "4b8f77"
    $Env:BASE16_COLOR_0D_HEX = "1ae1dc"
