# tinted-shell (base16) Solar Flare Light for PowerShell
# scheme made by Chuck Harmston (https://chuck.harmston.ch)

$Env:BASE16_THEME = "solarflare-light"

Write-Host -NoNewline "`e]4;0;rgb:f5/f7/fa`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:58/68/75`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:85/93/9e`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:18/26/2f`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:e6/6b/2b`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:d7/3c/9a`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:e8/e9/ed`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:a6/af/b8`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:66/75/81`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:22/2e/38`e\" # base06

Write-Host -NoNewline "`e]10;rgb:58/68/75`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:f5/f7/fa`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:58/68/75`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "f5f7fa"
    $Env:BASE16_COLOR_01_HEX = "e8e9ed"
    $Env:BASE16_COLOR_02_HEX = "a6afb8"
    $Env:BASE16_COLOR_03_HEX = "85939e"
    $Env:BASE16_COLOR_04_HEX = "667581"
    $Env:BASE16_COLOR_05_HEX = "586875"
    $Env:BASE16_COLOR_06_HEX = "222e38"
    $Env:BASE16_COLOR_07_HEX = "18262f"
