# tinted-shell (base16) Tokyo Night Terminal Dark for PowerShell
# scheme made by Michaël Ball

$Env:BASE16_THEME = "tokyo-night-terminal-dark"

Write-Host -NoNewline "`e]4;0;rgb:16/16/1e`e\" # base00
...
if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:16/16/1e`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:78/7c/99`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "16161e"
    $Env:BASE16_COLOR_01_HEX = "1a1b26"
    $Env:BASE16_COLOR_02_HEX = "2f3549"
