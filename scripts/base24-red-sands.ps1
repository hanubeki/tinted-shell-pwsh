# tinted-shell (base24) Red Sands for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "red-sands"

Write-Host -NoNewline "`e]4;0;rgb:79/24/1e`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:ff/3f/00`e\" # base08
Write-Host -NoNewline "`e]4;2;rgb:00/bb/00`e\" # base0B
Write-Host -NoNewline "`e]4;3;rgb:00/71/ae`e\" # base0A
Write-Host -NoNewline "`e]4;4;rgb:00/71/ff`e\" # base0D
...
Write-Host -NoNewline "`e]4;9;rgb:bb/00/00`e\" # base12
Write-Host -NoNewline "`e]4;10;rgb:00/bb/00`e\" # base14
Write-Host -NoNewline "`e]4;11;rgb:e7/b0/00`e\" # base13
Write-Host -NoNewline "`e]4;12;rgb:00/71/ae`e\" # base16
Write-Host -NoNewline "`e]4;13;rgb:ff/55/ff`e\" # base17
Write-Host -NoNewline "`e]4;14;rgb:55/ff/ff`e\" # base15
Write-Host -NoNewline "`e]4;15;rgb:ff/ff/ff`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:e7/b0/00`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:7f/1f/00`e\" # base0F
...
if ($Env:BASE24_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:79/24/1e`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:a1/a1/a1`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "79241e"
    ...
    $Env:BASE24_COLOR_08_HEX = "ff3f00"
    $Env:BASE24_COLOR_09_HEX = "e7b000"
    $Env:BASE24_COLOR_0A_HEX = "0071ae"
    $Env:BASE24_COLOR_0B_HEX = "00bb00"
    $Env:BASE24_COLOR_0C_HEX = "00bbbb"
    $Env:BASE24_COLOR_0D_HEX = "0071ff"
    $Env:BASE24_COLOR_0E_HEX = "bb00bb"
    $Env:BASE24_COLOR_0F_HEX = "7f1f00"
    $Env:BASE24_COLOR_10_HEX = "383838"
    $Env:BASE24_COLOR_11_HEX = "1c1c1c"
    $Env:BASE24_COLOR_12_HEX = "bb0000"
    $Env:BASE24_COLOR_13_HEX = "e7b000"
    $Env:BASE24_COLOR_14_HEX = "00bb00"
    $Env:BASE24_COLOR_15_HEX = "55ffff"
    $Env:BASE24_COLOR_16_HEX = "0071ae"
