# tinted-shell (base24) Tokyo Night Dark for PowerShell
# scheme made by Michaël Ball, based on Tokyo Night by enkia (https://github.com/enkia/tokyo-night-vscode-theme)

$Env:BASE24_THEME = "tokyo-night-dark"

Write-Host -NoNewline "`e]4;0;rgb:1a/1b/26`e\" # base00
...
Write-Host -NoNewline "`e]4;19;rgb:2f/35/49`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:78/7c/99`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:cb/cc/d1`e\" # base06
# Write-Host -NoNewline "`e]4;22;rgb:16/16/1e`e\" # base10
# Write-Host -NoNewline "`e]4;23;rgb:0f/0f/14`e\" # base11

Write-Host -NoNewline "`e]10;rgb:a9/b1/d6`e\" # base05

if ($Env:BASE24_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:1a/1b/26`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:a9/b1/d6`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "1a1b26"
    $Env:BASE24_COLOR_01_HEX = "16161e"
    $Env:BASE24_COLOR_02_HEX = "2f3549"
    ...
    $Env:BASE24_COLOR_10_HEX = "16161e"
    $Env:BASE24_COLOR_11_HEX = "0f0f14"
