# tinted-shell (base16) OneDark for PowerShell
# scheme made by Lalit Magant (http://github.com/tilal6991)

$Env:BASE16_THEME = "onedark"

Write-Host -NoNewline "`e]4;0;rgb:28/2c/34`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:e0/6c/75`e\" # base08
...
Write-Host -NoNewline "`e]4;5;rgb:c6/78/dd`e\" # base0E
Write-Host -NoNewline "`e]4;6;rgb:56/b6/c2`e\" # base0C
Write-Host -NoNewline "`e]4;7;rgb:ab/b2/bf`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:54/58/62`e\" # base03
Write-Host -NoNewline "`e]4;9;rgb:e0/6c/75`e\" # base08
...
Write-Host -NoNewline "`e]4;13;rgb:c6/78/dd`e\" # base0E
Write-Host -NoNewline "`e]4;14;rgb:56/b6/c2`e\" # base0C
...
Write-Host -NoNewline "`e]4;18;rgb:35/3b/45`e\" # base01
