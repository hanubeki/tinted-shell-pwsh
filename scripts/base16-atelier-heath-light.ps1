# tinted-shell (base16) Atelier Heath Light for PowerShell
# scheme made by Bram de Haan (http://atelierbramdehaan.nl)

$Env:BASE16_THEME = "atelier-heath-light"

Write-Host -NoNewline "`e]4;0;rgb:f7/f3/f7`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:69/5d/69`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:9e/8f/9e`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:1b/18/1b`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:a6/59/26`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:cc/33/cc`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:d8/ca/d8`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:ab/9b/ab`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:77/69/77`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:29/23/29`e\" # base06

Write-Host -NoNewline "`e]10;rgb:69/5d/69`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:f7/f3/f7`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:69/5d/69`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "f7f3f7"
    $Env:BASE16_COLOR_01_HEX = "d8cad8"
    $Env:BASE16_COLOR_02_HEX = "ab9bab"
    $Env:BASE16_COLOR_03_HEX = "9e8f9e"
    $Env:BASE16_COLOR_04_HEX = "776977"
    $Env:BASE16_COLOR_05_HEX = "695d69"
    $Env:BASE16_COLOR_06_HEX = "292329"
    $Env:BASE16_COLOR_07_HEX = "1b181b"
