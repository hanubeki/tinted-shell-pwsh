# tinted-shell (base16) Black Metal (Mayhem) for PowerShell
# scheme made by metalelf0 (https://github.com/metalelf0)

$Env:BASE16_THEME = "black-metal-mayhem"

Write-Host -NoNewline "`e]4;0;rgb:00/00/00`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:5f/87/87`e\" # base08
Write-Host -NoNewline "`e]4;2;rgb:f3/ec/d4`e\" # base0B
Write-Host -NoNewline "`e]4;3;rgb:ee/cc/6c`e\" # base0A
...
Write-Host -NoNewline "`e]4;10;rgb:f3/ec/d4`e\" # base0B
Write-Host -NoNewline "`e]4;11;rgb:ee/cc/6c`e\" # base0A
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_0A_HEX = "eecc6c"
    $Env:BASE16_COLOR_0B_HEX = "f3ecd4"
