# tinted-shell (base16) Synth Midnight Terminal Light for PowerShell
# scheme made by Michaël Ball (http://github.com/michael-ball/)

$Env:BASE16_THEME = "synth-midnight-light"

Write-Host -NoNewline "`e]4;0;rgb:dd/df/e0`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:28/29/2a`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:a3/a5/a6`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:05/06/08`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:ea/77/0d`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:cd/63/20`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:cf/d1/d2`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:c1/c3/c4`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:47/48/49`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:1a/1b/1c`e\" # base06

Write-Host -NoNewline "`e]10;rgb:28/29/2a`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:dd/df/e0`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:28/29/2a`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "dddfe0"
    $Env:BASE16_COLOR_01_HEX = "cfd1d2"
    $Env:BASE16_COLOR_02_HEX = "c1c3c4"
    $Env:BASE16_COLOR_03_HEX = "a3a5a6"
    $Env:BASE16_COLOR_04_HEX = "474849"
    $Env:BASE16_COLOR_05_HEX = "28292a"
    $Env:BASE16_COLOR_06_HEX = "1a1b1c"
    $Env:BASE16_COLOR_07_HEX = "050608"
