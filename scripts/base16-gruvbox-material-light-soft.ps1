# tinted-shell (base16) Gruvbox Material Light, Soft for PowerShell
# scheme made by Mayush Kumar (https://github.com/MayushKumar), sainnhe (https://github.com/sainnhe/gruvbox-material-vscode)

$Env:BASE16_THEME = "gruvbox-material-light-soft"

Write-Host -NoNewline "`e]4;0;rgb:f2/e5/bc`e\" # base00
...
Write-Host -NoNewline "`e]4;19;rgb:c9/b9/9a`e\" # base02
...
if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:f2/e5/bc`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:65/47/35`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "f2e5bc"
    $Env:BASE16_COLOR_01_HEX = "ebdbb2"
    $Env:BASE16_COLOR_02_HEX = "c9b99a"
