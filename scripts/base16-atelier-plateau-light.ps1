# tinted-shell (base16) Atelier Plateau Light for PowerShell
# scheme made by Bram de Haan (http://atelierbramdehaan.nl)

$Env:BASE16_THEME = "atelier-plateau-light"

Write-Host -NoNewline "`e]4;0;rgb:f4/ec/ec`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:58/50/50`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:7e/77/77`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:1b/18/18`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:b4/5a/3c`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:bd/51/87`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:e7/df/df`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:8a/85/85`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:65/5d/5d`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:29/24/24`e\" # base06

Write-Host -NoNewline "`e]10;rgb:58/50/50`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:f4/ec/ec`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:58/50/50`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "f4ecec"
    $Env:BASE16_COLOR_01_HEX = "e7dfdf"
    $Env:BASE16_COLOR_02_HEX = "8a8585"
    $Env:BASE16_COLOR_03_HEX = "7e7777"
    $Env:BASE16_COLOR_04_HEX = "655d5d"
    $Env:BASE16_COLOR_05_HEX = "585050"
    $Env:BASE16_COLOR_06_HEX = "292424"
    $Env:BASE16_COLOR_07_HEX = "1b1818"
