# tinted-shell (base16) Black Metal (Dark Funeral) for PowerShell
# scheme made by metalelf0 (https://github.com/metalelf0)

$Env:BASE16_THEME = "black-metal-dark-funeral"

Write-Host -NoNewline "`e]4;0;rgb:00/00/00`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:5f/87/87`e\" # base08
Write-Host -NoNewline "`e]4;2;rgb:d0/df/ee`e\" # base0B
Write-Host -NoNewline "`e]4;3;rgb:5f/81/a5`e\" # base0A
...
Write-Host -NoNewline "`e]4;10;rgb:d0/df/ee`e\" # base0B
Write-Host -NoNewline "`e]4;11;rgb:5f/81/a5`e\" # base0A
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_0A_HEX = "5f81a5"
    $Env:BASE16_COLOR_0B_HEX = "d0dfee"
