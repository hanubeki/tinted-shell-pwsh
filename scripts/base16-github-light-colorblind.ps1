# tinted-shell (base16) Github Light Colorblind for PowerShell
# scheme made by Tinted Theming (https://github.com/tinted-theming)

$Env:BASE16_THEME = "github-light-colorblind"
...
Write-Host -NoNewline "`e]4;9;rgb:8a/46/00`e\" # base08
...
Write-Host -NoNewline "`e]4;13;rgb:b3/59/00`e\" # base0E
Write-Host -NoNewline "`e]4;14;rgb:05/50/ae`e\" # base0C
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_07_HEX = "24292f"
    $Env:BASE16_COLOR_08_HEX = "8a4600"
    $Env:BASE16_COLOR_09_HEX = "0550ae"
    $Env:BASE16_COLOR_0A_HEX = "bf8700"
    $Env:BASE16_COLOR_0B_HEX = "0a3069"
    $Env:BASE16_COLOR_0C_HEX = "0550ae"
    $Env:BASE16_COLOR_0D_HEX = "8250df"
    $Env:BASE16_COLOR_0E_HEX = "b35900"
    $Env:BASE16_COLOR_0F_HEX = "6f3800"
}
