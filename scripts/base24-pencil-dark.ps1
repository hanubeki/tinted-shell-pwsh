# tinted-shell (base24) Pencil Dark for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "pencil-dark"
...
Write-Host -NoNewline "`e]4;15;rgb:f1/f1/f1`e\" # base07
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    ...
    $Env:BASE24_COLOR_07_HEX = "f1f1f1"
