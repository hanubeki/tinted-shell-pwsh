# tinted-shell (base16) Atelier Seaside for PowerShell
# scheme made by Bram de Haan (http://atelierbramdehaan.nl)

$Env:BASE16_THEME = "atelier-seaside"

Write-Host -NoNewline "`e]4;0;rgb:13/15/13`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:8c/a6/8c`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:68/7d/68`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:f4/fb/f4`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:87/71/1d`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:e6/19/c3`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:24/29/24`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:5e/6e/5e`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:80/99/80`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:cf/e8/cf`e\" # base06

Write-Host -NoNewline "`e]10;rgb:8c/a6/8c`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:13/15/13`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:8c/a6/8c`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "131513"
    $Env:BASE16_COLOR_01_HEX = "242924"
    $Env:BASE16_COLOR_02_HEX = "5e6e5e"
    $Env:BASE16_COLOR_03_HEX = "687d68"
    $Env:BASE16_COLOR_04_HEX = "809980"
    $Env:BASE16_COLOR_05_HEX = "8ca68c"
    $Env:BASE16_COLOR_06_HEX = "cfe8cf"
    $Env:BASE16_COLOR_07_HEX = "f4fbf4"
