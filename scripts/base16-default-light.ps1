# tinted-shell (base16) Default Light for PowerShell
# scheme made by Chris Kempson (http://chriskempson.com)

$Env:BASE16_THEME = "default-light"

Write-Host -NoNewline "`e]4;0;rgb:f8/f8/f8`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:ab/46/42`e\" # base08
Write-Host -NoNewline "`e]4;2;rgb:a1/b5/6c`e\" # base0B
Write-Host -NoNewline "`e]4;3;rgb:f7/ca/88`e\" # base0A
Write-Host -NoNewline "`e]4;4;rgb:7c/af/c2`e\" # base0D
Write-Host -NoNewline "`e]4;5;rgb:ba/8b/af`e\" # base0E
Write-Host -NoNewline "`e]4;6;rgb:86/c1/b9`e\" # base0C
...
Write-Host -NoNewline "`e]4;10;rgb:a1/b5/6c`e\" # base0B
Write-Host -NoNewline "`e]4;11;rgb:f7/ca/88`e\" # base0A
Write-Host -NoNewline "`e]4;12;rgb:7c/af/c2`e\" # base0D
Write-Host -NoNewline "`e]4;13;rgb:ba/8b/af`e\" # base0E
Write-Host -NoNewline "`e]4;14;rgb:86/c1/b9`e\" # base0C
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_0A_HEX = "f7ca88"
    $Env:BASE16_COLOR_0B_HEX = "a1b56c"
    $Env:BASE16_COLOR_0C_HEX = "86c1b9"
    $Env:BASE16_COLOR_0D_HEX = "7cafc2"
    $Env:BASE16_COLOR_0E_HEX = "ba8baf"
