...
Write-Host -NoNewline "`e]4;9;rgb:9d/00/06`e\" # base12
Write-Host -NoNewline "`e]4;10;rgb:79/74/0e`e\" # base14
Write-Host -NoNewline "`e]4;11;rgb:b5/76/14`e\" # base13
Write-Host -NoNewline "`e]4;12;rgb:07/66/78`e\" # base16
Write-Host -NoNewline "`e]4;13;rgb:8f/3f/71`e\" # base17
Write-Host -NoNewline "`e]4;14;rgb:42/7b/58`e\" # base15
...
# Write-Host -NoNewline "`e]4;22;rgb:f9/f6/d7`e\" # base10
# Write-Host -NoNewline "`e]4;23;rgb:fb/f9/e4`e\" # base11
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "fbf1c7"
    $Env:BASE24_COLOR_01_HEX = "ebdbb2"
    $Env:BASE24_COLOR_02_HEX = "d5c4a1"
    $Env:BASE24_COLOR_03_HEX = "bdae93"
    $Env:BASE24_COLOR_04_HEX = "7c6f64"
    $Env:BASE24_COLOR_05_HEX = "3c3836"
    $Env:BASE24_COLOR_06_HEX = "282828"
    $Env:BASE24_COLOR_07_HEX = "1d2021"
    ...
    $Env:BASE24_COLOR_10_HEX = "f9f6d7"
    $Env:BASE24_COLOR_11_HEX = "fbf9e4"
    $Env:BASE24_COLOR_12_HEX = "9d0006"
    $Env:BASE24_COLOR_13_HEX = "b57614"
    $Env:BASE24_COLOR_14_HEX = "79740e"
    $Env:BASE24_COLOR_15_HEX = "427b58"
    $Env:BASE24_COLOR_16_HEX = "076678"
    $Env:BASE24_COLOR_17_HEX = "8f3f71"
}
