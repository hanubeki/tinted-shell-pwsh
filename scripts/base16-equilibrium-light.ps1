# tinted-shell (base16) Equilibrium Light for PowerShell
# scheme made by Carlo Abelli

$Env:BASE16_THEME = "equilibrium-light"

Write-Host -NoNewline "`e]4;0;rgb:f5/f0/e7`e\" # base00
...
Write-Host -NoNewline "`e]4;8;rgb:73/77/7f`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:18/1c/22`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:bf/3e/05`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:c4/27/75`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:e7/e2/d9`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:d8/d4/cb`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:5a/5f/66`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:2c/31/38`e\" # base06

Write-Host -NoNewline "`e]10;rgb:43/47/4e`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:f5/f0/e7`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:43/47/4e`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "f5f0e7"
    $Env:BASE16_COLOR_01_HEX = "e7e2d9"
    $Env:BASE16_COLOR_02_HEX = "d8d4cb"
    $Env:BASE16_COLOR_03_HEX = "73777f"
    $Env:BASE16_COLOR_04_HEX = "5a5f66"
    $Env:BASE16_COLOR_05_HEX = "43474e"
    $Env:BASE16_COLOR_06_HEX = "2c3138"
    $Env:BASE16_COLOR_07_HEX = "181c22"
