# tinted-shell (base24) Builtin Solarized Dark for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "builtin-solarized-dark"
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "002b36"
    ...
    $Env:BASE24_COLOR_07_HEX = "fdf6e3"
