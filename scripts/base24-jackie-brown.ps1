# tinted-shell (base24) Jackie Brown for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "jackie-brown"

Write-Host -NoNewline "`e]4;0;rgb:2c/1c/15`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:ef/57/34`e\" # base08
Write-Host -NoNewline "`e]4;2;rgb:2b/af/2b`e\" # base0B
Write-Host -NoNewline "`e]4;3;rgb:00/00/ff`e\" # base0A
Write-Host -NoNewline "`e]4;4;rgb:24/6d/b2`e\" # base0D
Write-Host -NoNewline "`e]4;5;rgb:cf/5e/c0`e\" # base0E
Write-Host -NoNewline "`e]4;6;rgb:00/ac/ee`e\" # base0C
...
Write-Host -NoNewline "`e]4;16;rgb:bd/be/00`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:77/2b/1a`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:2c/1d/16`e\" # base01
...
if ($Env:BASE24_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:2c/1c/15`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:a8/a8/a8`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "2c1c15"
    $Env:BASE24_COLOR_01_HEX = "2c1d16"
    ...
    $Env:BASE24_COLOR_08_HEX = "ef5734"
    $Env:BASE24_COLOR_09_HEX = "bdbe00"
    $Env:BASE24_COLOR_0A_HEX = "0000ff"
    $Env:BASE24_COLOR_0B_HEX = "2baf2b"
    $Env:BASE24_COLOR_0C_HEX = "00acee"
    $Env:BASE24_COLOR_0D_HEX = "246db2"
    $Env:BASE24_COLOR_0E_HEX = "cf5ec0"
    $Env:BASE24_COLOR_0F_HEX = "772b1a"
