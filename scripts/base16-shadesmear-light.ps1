# tinted-shell (base16) ShadeSmear Light for PowerShell
# scheme made by Kyle Giammarco (http://kyle.giammar.co)

$Env:BASE16_THEME = "shadesmear-light"

Write-Host -NoNewline "`e]4;0;rgb:db/db/db`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:23/23/23`e\" # base05
...
Write-Host -NoNewline "`e]4;15;rgb:e4/e4/e4`e\" # base07
...
Write-Host -NoNewline "`e]4;20;rgb:1c/1c/1c`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:1c/1c/1c`e\" # base06

Write-Host -NoNewline "`e]10;rgb:23/23/23`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:db/db/db`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:23/23/23`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "dbdbdb"
    $Env:BASE16_COLOR_01_HEX = "e4e4e4"
    $Env:BASE16_COLOR_02_HEX = "c0c0c0"
    $Env:BASE16_COLOR_03_HEX = "4e4e4e"
    $Env:BASE16_COLOR_04_HEX = "1c1c1c"
    $Env:BASE16_COLOR_05_HEX = "232323"
    $Env:BASE16_COLOR_06_HEX = "1c1c1c"
    $Env:BASE16_COLOR_07_HEX = "e4e4e4"
