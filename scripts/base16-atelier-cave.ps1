# tinted-shell (base16) Atelier Cave for PowerShell
# scheme made by Bram de Haan (http://atelierbramdehaan.nl)

$Env:BASE16_THEME = "atelier-cave"

Write-Host -NoNewline "`e]4;0;rgb:19/17/1c`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:8b/87/92`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:65/5f/6d`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:ef/ec/f4`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:aa/57/3c`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:bf/40/bf`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:26/23/2a`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:58/52/60`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:7e/78/87`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:e2/df/e7`e\" # base06

Write-Host -NoNewline "`e]10;rgb:8b/87/92`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:19/17/1c`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:8b/87/92`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "19171c"
    $Env:BASE16_COLOR_01_HEX = "26232a"
    $Env:BASE16_COLOR_02_HEX = "585260"
    $Env:BASE16_COLOR_03_HEX = "655f6d"
    $Env:BASE16_COLOR_04_HEX = "7e7887"
    $Env:BASE16_COLOR_05_HEX = "8b8792"
    $Env:BASE16_COLOR_06_HEX = "e2dfe7"
    $Env:BASE16_COLOR_07_HEX = "efecf4"
