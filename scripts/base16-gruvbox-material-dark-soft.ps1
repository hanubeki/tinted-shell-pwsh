# tinted-shell (base16) Gruvbox Material Dark, Soft for PowerShell
# scheme made by Mayush Kumar (https://github.com/MayushKumar), sainnhe (https://github.com/sainnhe/gruvbox-material-vscode)

$Env:BASE16_THEME = "gruvbox-material-dark-soft"

Write-Host -NoNewline "`e]4;0;rgb:32/30/2f`e\" # base00
...
Write-Host -NoNewline "`e]4;8;rgb:7c/6f/64`e\" # base03
...
Write-Host -NoNewline "`e]4;19;rgb:5a/52/4c`e\" # base02
...
if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:32/30/2f`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:dd/c7/a1`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "32302f"
    $Env:BASE16_COLOR_01_HEX = "3c3836"
    $Env:BASE16_COLOR_02_HEX = "5a524c"
    $Env:BASE16_COLOR_03_HEX = "7c6f64"
