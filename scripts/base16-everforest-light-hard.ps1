# tinted-shell (base16) Everforest Light (Hard) for PowerShell
# scheme made by Márcio Sobel (https://github.com/marciosobel)

$Env:BASE16_THEME = "everforest-light-hard"

Write-Host -NoNewline "`e]4;0;rgb:ff/fb/ef`e\" # base00
...
Write-Host -NoNewline "`e]4;15;rgb:27/2e/33`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:f5/7d/26`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:82/91/81`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:f8/f5/e4`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:ed/ea/da`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:82/91/81`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:41/4b/50`e\" # base06

Write-Host -NoNewline "`e]10;rgb:5c/6a/72`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:ff/fb/ef`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:5c/6a/72`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "fffbef"
    $Env:BASE16_COLOR_01_HEX = "f8f5e4"
    $Env:BASE16_COLOR_02_HEX = "edeada"
    $Env:BASE16_COLOR_03_HEX = "939f91"
    $Env:BASE16_COLOR_04_HEX = "829181"
    $Env:BASE16_COLOR_05_HEX = "5c6a72"
    $Env:BASE16_COLOR_06_HEX = "414b50"
    $Env:BASE16_COLOR_07_HEX = "272e33"
