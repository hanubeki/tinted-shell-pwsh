# tinted-shell (base16) boo-shnickle for PowerShell
# scheme made by boo-shnickle (@boo_shnickle)

$Env:BASE16_THEME = "boo-shnickle"

Write-Host -NoNewline "`e]4;0;rgb:19/19/14`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:bd/bd/97`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:7c/7c/63`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:ff/ff/cc`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:ff/dc/99`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:e5/d6/a6`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:3a/3a/2e`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:5b/5b/49`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:9c/9c/7d`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:de/de/b2`e\" # base06

Write-Host -NoNewline "`e]10;rgb:bd/bd/97`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:19/19/14`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:bd/bd/97`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "191914"
    $Env:BASE16_COLOR_01_HEX = "3a3a2e"
    $Env:BASE16_COLOR_02_HEX = "5b5b49"
    $Env:BASE16_COLOR_03_HEX = "7c7c63"
    $Env:BASE16_COLOR_04_HEX = "9c9c7d"
    $Env:BASE16_COLOR_05_HEX = "bdbd97"
    $Env:BASE16_COLOR_06_HEX = "dedeb2"
    $Env:BASE16_COLOR_07_HEX = "ffffcc"
