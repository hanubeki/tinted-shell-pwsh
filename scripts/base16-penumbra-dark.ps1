# tinted-shell (base16) Penumbra Dark for PowerShell
# scheme made by Zachary Weiss (https://github.com/zacharyweiss)

$Env:BASE16_THEME = "penumbra-dark"

Write-Host -NoNewline "`e]4;0;rgb:24/27/2b`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:be/be/be`e\" # base05
...
Write-Host -NoNewline "`e]4;18;rgb:30/33/38`e\" # base01
...
Write-Host -NoNewline "`e]10;rgb:be/be/be`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:24/27/2b`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:be/be/be`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "24272b"
    $Env:BASE16_COLOR_01_HEX = "303338"
    $Env:BASE16_COLOR_02_HEX = "3e4044"
    $Env:BASE16_COLOR_03_HEX = "636363"
    $Env:BASE16_COLOR_04_HEX = "8f8f8f"
    $Env:BASE16_COLOR_05_HEX = "bebebe"
