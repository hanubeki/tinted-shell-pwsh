# tinted-shell (base16) Grayscale Light for PowerShell
# scheme made by Alexandre Gavioli (https://github.com/Alexx2/)

$Env:BASE16_THEME = "grayscale-light"
...
Write-Host -NoNewline "`e]4;7;rgb:46/46/46`e\" # base05
...
Write-Host -NoNewline "`e]4;15;rgb:10/10/10`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:99/99/99`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:5e/5e/5e`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:e3/e3/e3`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:b9/b9/b9`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:52/52/52`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:25/25/25`e\" # base06

Write-Host -NoNewline "`e]10;rgb:46/46/46`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:f7/f7/f7`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:46/46/46`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "f7f7f7"
    $Env:BASE16_COLOR_01_HEX = "e3e3e3"
    $Env:BASE16_COLOR_02_HEX = "b9b9b9"
    $Env:BASE16_COLOR_03_HEX = "ababab"
    $Env:BASE16_COLOR_04_HEX = "525252"
    $Env:BASE16_COLOR_05_HEX = "464646"
    $Env:BASE16_COLOR_06_HEX = "252525"
    $Env:BASE16_COLOR_07_HEX = "101010"
