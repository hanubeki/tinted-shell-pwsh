# tinted-shell (base16) Black Metal (Immortal) for PowerShell
# scheme made by metalelf0 (https://github.com/metalelf0)

$Env:BASE16_THEME = "black-metal-immortal"

Write-Host -NoNewline "`e]4;0;rgb:00/00/00`e\" # base00
Write-Host -NoNewline "`e]4;1;rgb:5f/87/87`e\" # base08
Write-Host -NoNewline "`e]4;2;rgb:77/99/bb`e\" # base0B
Write-Host -NoNewline "`e]4;3;rgb:55/66/77`e\" # base0A
...
Write-Host -NoNewline "`e]4;10;rgb:77/99/bb`e\" # base0B
Write-Host -NoNewline "`e]4;11;rgb:55/66/77`e\" # base0A
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_0A_HEX = "556677"
    $Env:BASE16_COLOR_0B_HEX = "7799bb"
