# tinted-shell (base16) Atelier Forest Light for PowerShell
# scheme made by Bram de Haan (http://atelierbramdehaan.nl)

$Env:BASE16_THEME = "atelier-forest-light"

Write-Host -NoNewline "`e]4;0;rgb:f1/ef/ee`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:68/61/5e`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:9c/94/91`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:1b/19/18`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:df/53/20`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:c3/3f/f3`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:e6/e2/e0`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:a8/a1/9f`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:76/6e/6b`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:2c/24/21`e\" # base06

Write-Host -NoNewline "`e]10;rgb:68/61/5e`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:f1/ef/ee`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:68/61/5e`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "f1efee"
    $Env:BASE16_COLOR_01_HEX = "e6e2e0"
    $Env:BASE16_COLOR_02_HEX = "a8a19f"
    $Env:BASE16_COLOR_03_HEX = "9c9491"
    $Env:BASE16_COLOR_04_HEX = "766e6b"
    $Env:BASE16_COLOR_05_HEX = "68615e"
    $Env:BASE16_COLOR_06_HEX = "2c2421"
    $Env:BASE16_COLOR_07_HEX = "1b1918"
