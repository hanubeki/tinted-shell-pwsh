# tinted-shell (base16) Da One Black for PowerShell
# scheme made by NNB (https://github.com/NNBnh)

$Env:BASE16_THEME = "da-one-black"
...
Write-Host -NoNewline "`e]4;8;rgb:88/88/88`e\" # base03
...
Write-Host -NoNewline "`e]4;19;rgb:58/58/58`e\" # base02
...
if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    ...
    $Env:BASE16_COLOR_02_HEX = "585858"
    $Env:BASE16_COLOR_03_HEX = "888888"
