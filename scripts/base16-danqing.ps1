# tinted-shell (base16) DanQing for PowerShell
# scheme made by Wenhan Zhu (Cosmos) (zhuwenhan950913@gmail.com)

$Env:BASE16_THEME = "danqing"

Write-Host -NoNewline "`e]4;0;rgb:2d/30/2f`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:e0/f0/ef`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:9d/a8/a3`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:fc/fe/fd`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:b3/8a/61`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:ca/69/24`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:43/48/46`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:5a/60/5d`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:ca/d8/d2`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:ec/f6/f2`e\" # base06

Write-Host -NoNewline "`e]10;rgb:e0/f0/ef`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:2d/30/2f`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:e0/f0/ef`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "2d302f"
    $Env:BASE16_COLOR_01_HEX = "434846"
    $Env:BASE16_COLOR_02_HEX = "5a605d"
    $Env:BASE16_COLOR_03_HEX = "9da8a3"
    $Env:BASE16_COLOR_04_HEX = "cad8d2"
    $Env:BASE16_COLOR_05_HEX = "e0f0ef"
    $Env:BASE16_COLOR_06_HEX = "ecf6f2"
    $Env:BASE16_COLOR_07_HEX = "fcfefd"
