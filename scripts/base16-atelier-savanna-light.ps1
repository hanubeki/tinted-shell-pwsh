# tinted-shell (base16) Atelier Savanna Light for PowerShell
# scheme made by Bram de Haan (http://atelierbramdehaan.nl)

$Env:BASE16_THEME = "atelier-savanna-light"

Write-Host -NoNewline "`e]4;0;rgb:ec/f4/ee`e\" # base00
...
Write-Host -NoNewline "`e]4;7;rgb:52/60/57`e\" # base05

Write-Host -NoNewline "`e]4;8;rgb:78/87/7d`e\" # base03
...
Write-Host -NoNewline "`e]4;15;rgb:17/1c/19`e\" # base07

Write-Host -NoNewline "`e]4;16;rgb:9f/71/3c`e\" # base09
Write-Host -NoNewline "`e]4;17;rgb:86/74/69`e\" # base0F
Write-Host -NoNewline "`e]4;18;rgb:df/e7/e2`e\" # base01
Write-Host -NoNewline "`e]4;19;rgb:87/92/8a`e\" # base02
Write-Host -NoNewline "`e]4;20;rgb:5f/6d/64`e\" # base04
Write-Host -NoNewline "`e]4;21;rgb:23/2a/25`e\" # base06

Write-Host -NoNewline "`e]10;rgb:52/60/57`e\" # base05

if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:ec/f4/ee`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:52/60/57`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "ecf4ee"
    $Env:BASE16_COLOR_01_HEX = "dfe7e2"
    $Env:BASE16_COLOR_02_HEX = "87928a"
    $Env:BASE16_COLOR_03_HEX = "78877d"
    $Env:BASE16_COLOR_04_HEX = "5f6d64"
    $Env:BASE16_COLOR_05_HEX = "526057"
    $Env:BASE16_COLOR_06_HEX = "232a25"
    $Env:BASE16_COLOR_07_HEX = "171c19"
