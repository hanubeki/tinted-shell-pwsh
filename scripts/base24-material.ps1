# tinted-shell (base24) Material for PowerShell
# scheme made by FredHappyface (https://github.com/fredHappyface)

$Env:BASE24_THEME = "material"

Write-Host -NoNewline "`e]4;0;rgb:ea/ea/ea`e\" # base00
...
if ($Env:BASE24_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:ea/ea/ea`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:c3/c3/c3`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE24_VARS")) {
    $Env:BASE24_COLOR_00_HEX = "eaeaea"
