# tinted-shell (base16) Da One Paper for PowerShell
# scheme made by NNB (https://github.com/NNBnh)

$Env:BASE16_THEME = "da-one-paper"

Write-Host -NoNewline "`e]4;0;rgb:fa/f0/dc`e\" # base00
...
if ($Env:BASE16_SHELL_SET_BACKGROUND -ne "false") {
    Write-Host -NoNewline "`e]11;rgb:fa/f0/dc`e\" # base00
}

Write-Host -NoNewline "`e]12;rgb:18/18/18`e\" # base05

if ($(Test-Path "Env:TINTED_SHELL_ENABLE_BASE16_VARS") -or $(Test-Path "Env:BASE16_SHELL_ENABLE_VARS")) {
    $Env:BASE16_COLOR_00_HEX = "faf0dc"
